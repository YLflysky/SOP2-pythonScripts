...
if __name__ == '__main__':
    ...
    # app.apply_invoice(order_no='M202104280932576662216354',i_type=1,i_channel='CMCC',i_title='开票',tax='445678909876543',email='995939534@qq.com',mobile='18623459409',mailingAddress='new')
    ...
    # app.get_invoice_info(order_no='M202104280932576662216354')
