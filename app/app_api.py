...
if __name__ == '__main__':
    ...
    # app.apply_invoice(order_no='M202105111037424206757385',i_type=1,i_channel='CP',i_title='开票',tax='445678909876543',email='995939534@qq.com',mobile='18623459409')
    ...
    # app.get_invoice_info(order_no='ftb20210512104239275532480')
