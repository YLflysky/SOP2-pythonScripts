...
class Calendar(Base):
    ...
    def find_all_event(self,update_time):
        ...
        获取用户全部日历事件
        '''
        url = self.url + '/calendar/api/v1/calendar/event/findAll'
    ...
    def find_detail(self,id):
        ...
        获取用户单个日历事件详情
        """
        url = self.url + '/calendar/api/v1/calendar/event/findDetail'
        data = {'id':id}
        code,body = self.do_get(url,data)
        print(body)
        return body
    ...
    def add_event(self,start_time,end_time,**kwargs):
        url = self.url + '/calendar/api/v1/calendar/event/add'
    ...
    def del_event(self,event_id):
        url = self.url + '/calendar/api/v1/calendar/event/delete'
        data = {'id':event_id}
        code,body = self.do_delete(url,data)
        self.assert_msg(code,body)

    def update_event(self,event_id,s,e,**kwargs):
        url = self.url + '/calendar/api/v1/calendar/event/modify'
    ...
    def get_event_list(self,data):
        ...
        获取事件列表接口
        '''
        url = self.url + '/calendar/api/v1/calendar/event/getEventListBySpecifiedTime'
        code,body = self.do_get(url,data)
        print(body)
        return body

    def get_last_time(self,uid,deviceId):
        url = self.url + '/calendar/api/v1/calendar/event/getEventLastUpdatedTime'
        self.header['uid'] = uid
    ...
    def event_list_by_rule(self,api_type,st,et,uid,deviceId):
        ...
        self.header['uid'] = uid
        self.header['deviceId'] = deviceId
        url = self.url + '/calendar/api/v1/calendar/event/getEventFissionListByMonth'
    ...
    def mobile_sync(self,data):
        url = self.url + '/calendar/public/calendar/event/sync'
        c,b = self.do_post(url,data)
        self.assert_msg(c,b)
        return b

    def mobile_find_all(self,uid):
        url = self.url + '/calendar/public/calendar/event/findAll'
        self.header['uid']=uid
        code,body = self.do_get(url,None)
        self.assert_msg(code,body)
        return body['data']
