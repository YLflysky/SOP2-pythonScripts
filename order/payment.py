...
if __name__ == '__main__':
    ...
    pay.get_qr_code(aid='9351524',order_no='20201119172222421876544',channel='WECHAT_PAY')
    ...
    # pay.ali_pay_callback('trade_success', '2018091361389377', '20201119172317986745472', receipt_amount=57.00, gmt_payment=pay.time_delta(),
