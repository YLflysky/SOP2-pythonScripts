...
if __name__ == '__main__':
    ...
    pay.get_qr_code(aid='9351515',order_no='20201124142350661876544',channel='WECHAT_PAY')
    ...
    # pay.sync_pay_result('20201124131211565196608','9409',pay.time_delta(),999,'QR_PAY','BM','ALI_PAY')
